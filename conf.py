...
BLOG_AUTHOR = "Ayatana Indicator Developers"  # (translatable)
BLOG_TITLE = "Ayatana Indicators"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://AyatanaIndicators.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://AyatanaIndicators.github.io/"
BLOG_EMAIL = "webmaster@ayatana-indicators.org"
BLOG_DESCRIPTION = "The continuation of Ayatana Indicators"  # (translatable)
